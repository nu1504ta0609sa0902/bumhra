Feature: Each notification will have a fee associated with it. No processing of the notification will take place unless the payment has been completed.
  ...
  @mcm-22 @e2e
  Scenario Outline: Verify invoice processing of different types of notification
...
#      | 2                            | Ready for Invoicing | Unpaid             | Paid              |
#      | 3                            | Ready for Invoicing | Unpaid             | Paid              |
#      | 4                            | Ready for Invoicing | Unpaid             | Paid              |
